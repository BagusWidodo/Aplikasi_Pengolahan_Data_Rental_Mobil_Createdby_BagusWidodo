            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="#!"><?php $admin['nama'] ?></a></li>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index.php?halaman=mobil">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Mobil
                            </a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    if (isset($_GET['halaman'])) 
                    {
                        ...
                        elseif ($_GET['halaman']=="tambah_mobil") {
                            include 'tambah_mobil.php';
                        }
                        elseif ($_GET['halaman']=="tambah_pelanggan") {
                            include 'tambah_pelanggan.php';
                        }
                        elseif ($_GET['halaman']=="hapus_mobil") {
                            include 'hapus_mobil.php';
                        }
                        elseif ($_GET['halaman']=="edit_mobil") {
                            include 'edit_mobil.php';
                        }
                        elseif ($_GET['halaman']=="tambah_transaksi") {
                            include 'tambah_transaksi.php';
                        }
                        elseif ($_GET['halaman']=="hapus_transaksi") {
                            include 'hapus_transaksi.php';
                        }
                        elseif ($_GET['halaman']=="check_detail_transaksi") {
                            include 'check_detail_transaksi.php';
                        }
